  ...
  return (
    <div
      className={
        ...
        } text-inactive-white absolute top-[4%] z-[10] min-h-[4rem] w-4/5 rounded-2xl  p-3    drop-shadow-[0_0_20px_rgba(0,0,0,0.5)] md:w-1/4 `
      }
    >
      <h3 className="z-30 text-xl font-semibold">
        {!data?.isDanger ? "Well Done!" : "oh snap!"}
      </h3>
      <p className=" text-active-white font-black">{data?.massage}</p>
      <IoClose
        onClick={handleClose}
